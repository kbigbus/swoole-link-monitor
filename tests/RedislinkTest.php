...
class RedislinkTest extends TestCase
{
    ...
    public function __construct()
    {
        ...
        $config['linkList'][1]['noticeTimes'] = 1; //重置测试用例告警次数
        $this->link                           = new RedisLink($config['linkList'][1], $memoryTable, $logger);
    }
